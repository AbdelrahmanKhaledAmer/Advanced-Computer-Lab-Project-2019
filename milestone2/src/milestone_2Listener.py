...
class milestone_2Listener(ParseTreeListener):
    ...
    # Enter a parse tree produced by milestone_2Parser#line.
    def enterLine(self, ctx:milestone_2Parser.LineContext):
        pass

    # Exit a parse tree produced by milestone_2Parser#line.
    def exitLine(self, ctx:milestone_2Parser.LineContext):
        pass
