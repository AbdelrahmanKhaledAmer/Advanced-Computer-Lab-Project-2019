...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\3\3\3\2\2\4\2\4\2\3\4\2\3wy~\r\2\6\3\2\2\2\4\13\3\2\2")
        buf.write("\2\6\7\t\2\2\2\7\3\3\2\2\2\b\n\5\2\2\2\t\b\3\2\2\2\n\r")
        buf.write("\3\2\2\2\13\t\3\2\2\2\13\f\3\2\2\2\f\5\3\2\2\2\r\13\3")
        buf.write("\2\2\2\3\13")
        return buf.getvalue()
...
class milestone_1Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "AND", "VARIABLE", "ADDR", "AS", "ASM", 
                      ...
                      "TRIPLESTR_ITEM", "RSTR_STR", "GENERALIZED_STR_LIT", 
                      "GENERALIZED_TRIPLESTR_LIT", "COMMENT", "MULTILINE_COMMENT", 
                      "INDENT", "WHITESPACE" ]
    ...
    class LineContext(ParserRuleContext):
        ...
        def TRIPLESTR_ITEM(self):
            return self.getToken(milestone_1Parser.TRIPLESTR_ITEM, 0)

        def RSTR_STR(self):
            return self.getToken(milestone_1Parser.RSTR_STR, 0)
